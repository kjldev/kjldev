...
export default function Navigation() {
	...
	return (
		<nav class='relative flex items-center justify-between p-2 text-sm font-semibold heading'>
			...
			{/* Right side: SayHello, GitHub logo, Theme toggle, and Hamburger button */}
			<div class='flex items-center space-x-4'>
				...
				>
					<svg
						...
						class='w-6 h-6 fill-current text-gray-900 dark:text-gray-100'
					>
						<title>GitHub</title>
				...
				<ThemeToggle />
				<button
					class='md:hidden focus:outline-none cursor-pointer text-gray-900 dark:text-gray-100'
